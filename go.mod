module github.com/linuxsuren/atest-ext-store-terminal

go 1.24.3

require (
	github.com/linuxsuren/api-testing v0.0.21-0.20251112072338-c3df5400d197
...
require (
	...
	github.com/linuxsuren/go-service v0.0.1 // indirect
